...
void SerialPort::setHwFlowCtl(int on)
{
    struct termios tty;
 ...
 */
void SerialPort::setTerm(int newSpeed, TermParity par, uint8_t nBits, uint8_t stopb,
                         int hwf, int swf)
{
    struct termios tty;
 ...
 */
int SerialPort::setcbreak(int mode)
{
    struct termios tty;
    static int init = 0;
